...
- **2026-09-10 20:00 예능 효과판 실측 (38초 4K60 컷 편집본):** OpenAI whisper-1 전사 10초, 컷 편집본 4K 렌더 236초, OCR 162초, 최종 렌더(스티커 3+자막+효과 6) 262초, 업로드 30초. 아이콘은 OVERLAY_HEIGHT=0.24 + top-left 로 사람과 안 겹침 확인. 저장소 success_test 가 404/403 이 되어 커밋 32dc81b 는 로컬에만 있음 → 사용자가 새 저장소(success) 접근을 열면 푸시.
